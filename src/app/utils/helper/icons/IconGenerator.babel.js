...
const _icons = {
  ...
  'location': {
    ...
    viewBox: '0 0 16 20',
    path: 'M15.636 3.895l-7.143 14.286q-0.19 0.391-0.636 0.391-0.056 0-0.167-0.022-0.246-0.056-0.396-0.251t-0.151-0.441v-6.429h-6.429q-0.246 0-0.441-0.151t-0.251-0.396 0.045-0.469 0.324-0.335l14.286-7.143q0.145-0.078 0.324-0.078 0.301 0 0.502 0.212 0.167 0.156 0.206 0.385t-0.073 0.441z'
  },
  'map': {
    id: 'icon-map',
