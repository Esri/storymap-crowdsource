  ...
  'root': ({
    ...
    contribute: {
      ...
      defaultForm: {
        ...
        termsAndConditions: {
          legal: 'تُقر وتتعهد بما يلي: 
(1) تمتلك جميع الحقوق والملكيات الخاصة بالصور التي تتم مشاركتها على هذا الموقع وتمنح Esri والشركات المتعاقدة معها الحق غير الحصري غير المحدود لاستخدام ونسخ وتخزين وإخفاء واستضافة وإعداد الأعمال المشتقة  واستنساخ الصورة التي تتم مشاركتها وعرضها بشكل عام وإعادة توزيعها وإعادة نشرها كجزء من هذه الخدمة.
(2) لا تنتهك أو تختلس الصور ومعلومات المواقع الجغرافية المتعلقة التي تتم مشاركتها حقوق الغير سواء الخاصة أو العامة. ويحظر تمامًا مشاركة الصور التي قد تعتبر تشهيرية أو فاحشة أو إباحية أو عنيفة للغاية أو التشجيع على ممارسة أنشطة غير قانونية.'
        }
      }
    },
    review: {
