  ...
  root: {
    ...
    betaMessage: {
      ...
      messageParagraphs: [
        ...
        'If a Crowdsource story is modified outside the builder, however, there is a possibility it may not work with the final version of the app. For more information please read the FAQs in the Help section of the app.'
      ]
    },
    common: {
